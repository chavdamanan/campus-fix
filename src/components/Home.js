...
const IMAGES = [
  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMt6yA3pH-oMI4pz5xhCqYsV2AfV4VC6c5Zg&s',
  'https://money-assets.money.com/mcp/2025/243744.jpg',
        ...
        <div className="hero-content">
          <div className="brand-hero">
            <div className="brand-logo-large" aria-hidden="true">
              <svg width="56" height="56" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="3" width="20" height="18" rx="5" fill="url(#g)"/><defs><linearGradient id="g" x1="0" x2="1"><stop offset="0" stopColor="#60a5fa"/><stop offset="1" stopColor="#3b82f6"/></linearGradient></defs></svg>
            </div>
